...
export function Register() {
    ...
    try {
      ...
      if (username) {
        response = await axios.get(
          `https://backend-mintickets.vercel.app//users/username/${username}`
        );
      } else if (email) {
        response = await axios.get(
          `https://backend-mintickets.vercel.app//users/email/${email}`
        );
      } else if (firstName) {
        response = await axios.get(
          `https://backend-mintickets.vercel.app//users/firstName/${firstName}`
        );
      } else if (lastName) {
        response = await axios.get(
          `https://backend-mintickets.vercel.app//users/lastName/${lastName}`
        );
      } else {
  ...
  const eliminarUsuario = async () => {
    try {
      if (foundUser) {
        await axios.delete(
          `https://backend-mintickets.vercel.app//users/${foundUser.username}`
        );
    ...
    try {
      ...
      if (foundUser) {
        const response = await axios.put(
          `https://backend-mintickets.vercel.app//users/username/${foundUser.username}`,
          userData
        );
        ...
        const response = await axios.post(
          "https://backend-mintickets.vercel.app//register",
          userData
        );
